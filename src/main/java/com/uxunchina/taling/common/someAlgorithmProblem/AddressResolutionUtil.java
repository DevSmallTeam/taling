    ...
    public static Map<String, String> addressResolution2(String address) {
        ...
        while (matcher.find()) {
            ...
            if (flag) {
                ...
                row.put("city", province == null ? null : province.trim());
            }
